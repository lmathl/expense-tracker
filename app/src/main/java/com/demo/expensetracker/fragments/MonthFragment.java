...
public class MonthFragment extends Fragment {
    ...
    private void enableSwipeToDeleteAndUndo() {
        ...
        SwipeToDeleteCallback swipeToDeleteCallback = new SwipeToDeleteCallback(getContext()) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                tvTotalSum.setText("$" + recordHelper.getTotalAmountSpent(adapter.getRecords()));
    ...
    public static ArrayList<String> generateRandomExpensesEng() {
        ArrayList<String> enExpenses = new ArrayList<String>();
        for (int i = 30; i < 60; i++) {
            enExpenses.add("cct " + i);
            enExpenses.add("take away food " + i);
        }
        for (int i = 10; i < 20; i++) {
            enExpenses.add("milk & bread " + i);
            enExpenses.add("cereal " + i);
        }
        for (int i = 50; i < 100; i++) {
            enExpenses.add("dinning out " + i);
            enExpenses.add("essentials " + i);
        }
        for (int i = 500; i < 550; i++) {
            enExpenses.add("something expensive " + i);
            enExpenses.add("personal spendings " + i);
        }
    ...
    public static String generateRandomDescription(ArrayList<String> expenses) {
